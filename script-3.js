(function(){
  ...
  form.addEventListener('submit',function(e){
    ...
    var text='📋 Новая заявка с сайта Смена\n\n👤 Имя: '+name+'\n📱 Телефон: '+phone+'\n📧 Email: '+email+'\n🏢 Компания: '+company+'\n💬 Описание: '+message;
    
    var img=new Image();
    img.src='https://api.telegram.org/bot'+telegramToken+'/sendMessage?chat_id='+telegramChatId+'&text='+encodeURIComponent(text);
    
    setTimeout(function(){form.classList.add('sent');btn.disabled=false;btn.textContent='Отправить заявку';},700);
  });
